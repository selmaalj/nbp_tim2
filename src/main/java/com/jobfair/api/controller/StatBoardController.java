...
public class StatBoardController extends AbstractCrudController<String, StatBoardRequest, StatBoardResponse> {
    ...
    @Operation(summary = "Get stat board by slug")
    ...
    @Operation(summary = "Get stat boards by year")
    ...
    @GetMapping(params = "q")
    @Operation(summary = "Search stat boards")
    ...
    @GetMapping("/filter")
    @Operation(summary = "Filter stat boards")
