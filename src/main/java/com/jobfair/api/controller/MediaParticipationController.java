...
public class MediaParticipationController extends AbstractCrudController<String, MediaParticipationRequest, MediaParticipationResponse> {
    ...
    @Operation(summary = "Get media participations by year")
    ...
    @Operation(summary = "Get media participations by outlet ID")
    ...
    @GetMapping("/filter")
    @Operation(summary = "Filter media participations")
